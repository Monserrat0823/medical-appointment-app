{{-- logica de php para manejar errores y controlar la pesetana activa --}}
@php
    ...
    //si hay errrores, buscamos en que grupo estan para abrir esa pestana auntnaticamente
        ...
        <x-wire-card>
            <x-tabs :active="$initialTab">
                <x-slot name="header">
                    ...
                    <x-tabs-link tab="antecedentes" :error="$error">
                    ...
                    <x-tabs-link tab="informacion-general" :error="$error">
                    ...
                    <x-tabs-link tab="contacto-emergencia" :error="$error">
                        <i class="fa-solid fa-heart me-2"></i>
                        Contacto de emergencia
                    </x-tabs-link>
                </x-slot>

                {{-- Cambiamos los div x-show por x-tab-contente para --}}
                ...
                <x-tab-content tab="contacto-emergencia">
                    ...
                    <div class="space-y-4">
                        ...
                        <x-wire-phone label="Teléfono del contacto" name="emergency_contact_phone" mask="(###) ###-####"
